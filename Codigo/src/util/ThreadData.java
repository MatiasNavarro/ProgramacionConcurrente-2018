...
public class ThreadData{
	...
	public static void setAcciones(HashMap<Integer,Accion> acciones) {
		...
		a_EleccionP1=new Accion[1];
		a_EleccionP1[0]=acciones.get(t_EleccionP1[0]);

		a_EleccionP2=new Accion[1];
		a_EleccionP2[0]=acciones.get(t_EleccionP2[0]);
	...
	public Accion[] get_a_BarreraE1(){
		return a_BarreraE1;
	}

	public Accion[] get_a_BarreraE2(){
		return a_BarreraE2;
	}

	public Accion[] get_a_BarreraE3(){
		return a_BarreraE3;
	}

	public Accion[] get_a_EleccionP1(){
		return a_EleccionP1;
	}

	public Accion[] get_a_EleccionP2(){
		return a_EleccionP2;
	}


	public Accion[] get_a_Bajada(){
		return a_Bajada;
	}

	public Accion[] get_a_Subida(){
		return a_Subida;
	}

	public Accion[] get_a_IrAcaja1(){
		return a_IrACaja1;
	}

	public Accion[] get_a_IrACaja2(){
		return a_IrACaja2;
	}

	public Accion[] get_a_CobrarPiso1(){
		return a_CobrarPiso1;
	}

	public Accion[] get_a_CobrarPiso2(){
		return a_CobrarPiso2;
	}

	public Accion[] get_a_EleccionS1(){
		return a_EleccionS1;
	}

	public Accion[] get_a_EleccionS2(){
		return a_EleccionS2;
	}

	public Accion[] get_a_BarreraS2(){
		return a_BarreraS2;
	}

	public Accion[] get_a_BarreraS1(){
		return a_BarreraS1;
	}

	public Accion[] get_a_Calle(){
		return a_Calle;
	}

	public Accion[] get_a_Cartel(){
		return a_Cartel;
	}
}